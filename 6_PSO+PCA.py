...
#    joblib.dump(eigVects,'./features/PCA/eigVects_train_%s.eig' %m,compress=3)
    ...
    eigVals = joblib.load('./features/PCA/20pixel/eigVals_train_%s.eig' %m)
    eigVects = joblib.load('./features/PCA/20pixel/eigVects_train_%s.eig' %m)
